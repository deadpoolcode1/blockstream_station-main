...
makecross: main.cpp
	unset LD_LIBRARY_PATH && source /opt/petalinux/2022.2/environment-setup-cortexa9t2hf-neon-xilinx-linux-gnueabi && $(CROSS_COMPILER) $(CXXFLAGS) $(CROSS_OPTIONS) -Og main.cpp libs/database.cpp -g -o $(OUTPUT_CROSS) -lpthread -lzmq -lmysqlclient
	@echo "Build for cross-compilation complete"

makepc: main.cpp
	$(CXX) $(CXXFLAGS) -Og main.cpp libs/database.cpp -g -o $(OUTPUT_HOST) -lpthread -lzmq  -lmysqlclient
